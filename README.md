...
Output of SCC (see scc_result.txt) is evaluated and significant protein interactions are identified (pid_nr_res5.txt). Results show top sizes 3,2,2,2,2,2,2. Size indicates protein interactions: for 3 a -> b, b -> c, c -> a and for size 2 a -> b, b -> a.
